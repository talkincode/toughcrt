...
from txweb.btforms import dataform
...
radius_form = btforms.Form(
    ...
    btforms.Textbox("authorize_port", description=u"COA端口" , **input_style),
    btforms.Textbox("interim_update", description=u"记账间隔" , **input_style),
    btforms.Button("submit", type="submit", html=u"<b>更新</b>", **button_style),
    title=u"Radius配置管理",
    action="/admin/config/radius/update"
)
